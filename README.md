...
```shell
$ cd /src/kernels
$ snakemake --cores=1 saxpy/64xf32/linalg.x
$ ls saxpy/64xf32/*.x # linalg.x should exist if all went OK
```
...
The [Snakefile](kernels/Snakefile) performs the following steps:
...
```shell
$ cd /src/kernels
$ snakemake --cores=1 saxpy/64xf32/linalg.profile.json
```
...
```shell
$ ls saxpy/64xf32/linalg.logs/
saxpy/64xf32/linalg.logs/trace_hart_00000000.trace.txt  # decoded trace
saxpy/64xf32/linalg.logs/trace_hart_00000000.trace.json # json performance data per section
```
...
```shell
$ cat saxpy/64xf32/linalg.logs/trace_hart_00000000.trace.json
...
```shell
$ grep -B2 -A3 1322 saxpy/64xf32/linalg.logs/trace_hart_00000000.trace.txt
...
```shell
$ grep fmul\.s saxpy/64xf32/linalg.logs/trace_hart_00000000.trace.txt  | wc -l
64
$ grep fmul\.s saxpy/64xf32/linalg.logs/trace_hart_00000001.trace.txt  | wc -l
0
```
