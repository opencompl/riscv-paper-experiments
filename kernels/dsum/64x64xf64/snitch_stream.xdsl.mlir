riscv.assembly_section ".text" {
  ...
  riscv_func.func @dsum(%X : !riscv.reg<a0>, %Y : !riscv.reg<a1>, %Z : !riscv.reg<a2>) {
    ...
    %stride_pattern = "snitch_stream.stride_pattern"() {"ub" = [#builtin.int<2048>], "strides" = [#builtin.int<8>], "dm" = #builtin.int<31>} : () -> !snitch_stream.stride_pattern_type<1>
    ...
    ^bb0(%X_stream : !stream.readable<!riscv.freg<ft0>>, %Y_stream : !stream.readable<!riscv.freg<ft1>>, %Z_stream : !stream.writable<!riscv.freg<ft2>>):
      ...
      %c4095 = riscv.li 4095 : () -> !riscv.reg<>
      riscv_snitch.frep_outer %c4095 {
