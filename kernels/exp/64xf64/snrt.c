...
void exp_kernel(const DTYPE* x, DTYPE* z) {
    ...
    // Remark 2: Luca Colagrande's implementation of exp ("exp_optimized")on f64 data arrays but guarantees f32 accuray only.
    // For any other DTYPE we convert the data to double explicitly first before calling exp_optimized
