...
// g[ M x N ]
  riscv_func.func @matmul(
    ...
    %target_count = riscv.li 128 : () -> !riscv.reg<>

    "snitch_stream.streaming_region"(%X_moved, %Y_moved, %G_moved) <{
      "stride_patterns" = [
        #snitch_stream.stride_pattern<ub = [16, 2, 16, 4], strides = [128, 0, 8, 0]>,
        #snitch_stream.stride_pattern<ub = [16, 2, 16, 4], strides = [0, 32, 64, 8]>,
