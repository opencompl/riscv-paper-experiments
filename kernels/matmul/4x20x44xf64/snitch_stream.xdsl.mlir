...
// g[ M x N ]
  riscv_func.func @matmul(
    ...
    %target_count = riscv.li 176 : () -> !riscv.reg<>

    "snitch_stream.streaming_region"(%X_moved, %Y_moved, %G_moved) <{
      "stride_patterns" = [
        #snitch_stream.stride_pattern<ub = [4, 11, 20, 4], strides = [160, 0, 8, 0]>,
        #snitch_stream.stride_pattern<ub = [4, 11, 20, 4], strides = [0, 32, 352, 8]>,
        #snitch_stream.stride_pattern<ub = [176], strides = [8]>
      ],
