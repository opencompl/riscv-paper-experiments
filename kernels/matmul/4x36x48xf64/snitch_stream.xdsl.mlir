...
// g[ M x N ]
  riscv_func.func @matmul(
    ...
    %frep_count_minus_one = riscv.li 33 : () -> !riscv.reg<>
    %target_count = riscv.li 192 : () -> !riscv.reg<>

    "snitch_stream.streaming_region"(%X_moved, %Y_moved, %G_moved) <{
      "stride_patterns" = [
        #snitch_stream.stride_pattern<ub = [4, 12, 36, 4], strides = [288, 0, 8, 0]>,
        #snitch_stream.stride_pattern<ub = [4, 12, 36, 4], strides = [0, 32, 384, 8]>,
