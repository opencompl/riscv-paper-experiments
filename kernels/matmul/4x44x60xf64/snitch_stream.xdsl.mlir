...
// g[ M x N ]
  riscv_func.func @matmul(
    ...
    %target_count = riscv.li 240 : () -> !riscv.reg<>

    "snitch_stream.streaming_region"(%X_moved, %Y_moved, %G_moved) <{
      "stride_patterns" = [
        #snitch_stream.stride_pattern<ub = [4, 15, 44, 4], strides = [352, 0, 8, 0]>,
        #snitch_stream.stride_pattern<ub = [4, 15, 44, 4], strides = [0, 32, 480, 8]>,
        #snitch_stream.stride_pattern<ub = [240], strides = [8]>
      ],
