...
// g[ M x N ]
  riscv_func.func @matmul(
    ...
    %target_count = riscv.li 80 : () -> !riscv.reg<>

    "snitch_stream.streaming_region"(%X_moved, %Y_moved, %G_moved) <{
      "stride_patterns" = [
        #snitch_stream.stride_pattern<ub = [4, 5, 56, 4], strides = [448, 0, 8, 0]>,
        #snitch_stream.stride_pattern<ub = [4, 5, 56, 4], strides = [0, 32, 160, 8]>,
        #snitch_stream.stride_pattern<ub = [80], strides = [8]>
      ],
