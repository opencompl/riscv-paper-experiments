...
// g[ M x N ]
  riscv_func.func @matmul(
    ...
    %target_count = riscv.li 352 : () -> !riscv.reg<>

    "snitch_stream.streaming_region"(%X_moved, %Y_moved, %G_moved) <{
      "stride_patterns" = [
        #snitch_stream.stride_pattern<ub = [8, 11, 24, 4], strides = [192, 0, 8, 0]>,
        #snitch_stream.stride_pattern<ub = [8, 11, 24, 4], strides = [0, 32, 352, 8]>,
        #snitch_stream.stride_pattern<ub = [352], strides = [8]>
      ],
