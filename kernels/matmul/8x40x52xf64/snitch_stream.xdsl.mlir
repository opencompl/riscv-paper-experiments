...
// g[ M x N ]
  riscv_func.func @matmul(
    ...
    %frep_count_minus_one = riscv.li 37 : () -> !riscv.reg<>
    %target_count = riscv.li 416 : () -> !riscv.reg<>

    "snitch_stream.streaming_region"(%X_moved, %Y_moved, %G_moved) <{
      "stride_patterns" = [
        #snitch_stream.stride_pattern<ub = [8, 13, 40, 4], strides = [320, 0, 8, 0]>,
        #snitch_stream.stride_pattern<ub = [8, 13, 40, 4], strides = [0, 32, 416, 8]>,
