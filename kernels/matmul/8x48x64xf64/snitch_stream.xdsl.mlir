...
// g[ M x N ]
  riscv_func.func @matmul(
    ...
    %target_count = riscv.li 512 : () -> !riscv.reg<>

    "snitch_stream.streaming_region"(%X_moved, %Y_moved, %G_moved) <{
      "stride_patterns" = [
        #snitch_stream.stride_pattern<ub = [8, 16, 48, 4], strides = [384, 0, 8, 0]>,
        #snitch_stream.stride_pattern<ub = [8, 16, 48, 4], strides = [0, 32, 512, 8]>,
        #snitch_stream.stride_pattern<ub = [512], strides = [8]>
      ],
