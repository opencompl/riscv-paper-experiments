...
// g[ M x N ]
  riscv_func.func @matmul(
    ...
    %target_count = riscv.li 288 : () -> !riscv.reg<>

    "snitch_stream.streaming_region"(%X_moved, %Y_moved, %G_moved) <{
      "stride_patterns" = [
        #snitch_stream.stride_pattern<ub = [8, 9, 52, 4], strides = [416, 0, 8, 0]>,
        #snitch_stream.stride_pattern<ub = [8, 9, 52, 4], strides = [0, 32, 288, 8]>,
        #snitch_stream.stride_pattern<ub = [288], strides = [8]>
      ],
