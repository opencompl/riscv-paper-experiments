builtin.module {
  func.func public @pooling_nchw_sum_d1_s2_3x3(%arg0 : memref<1x1x16x16xf64> {"llvm.noalias"}, %arg1 : memref<1x1x7x7xf64> {"llvm.noalias"}) -> memref<1x1x7x7xf64> {
      ...
      scf.for %arg3 = %c0 to %c7 step %c1 {
        scf.for %arg4 = %c0 to %c3 step %c1 {
          scf.for %arg5 = %c0 to %c3 step %c1 {
            ...
            %6 = arith.addf %5, %4 fastmath<fast> : f64
