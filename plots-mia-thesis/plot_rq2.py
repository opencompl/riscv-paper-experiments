#!/usr/bin/env python3
"""
RQ2 plot: how does the Chebyshev polynomial degree affect cycles/byte and FPU
...
Usage:
    python plot_rq2.py \
        ...
        [--output plots-mia-thesis/output/rq2_plots.pdf]
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", "-o", default="plots-mia-thesis/output/rq2_plots.pdf",
