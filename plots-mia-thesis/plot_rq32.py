#!/usr/bin/env python3
"""
RQ32 plot: accuracy vs performance Pareto, one panel per precision (f16/f32/f64).
...
Usage:
    python plot_rq32.py [-i results/kernels.exp_micro.csv] \\
        [-o plots-mia-thesis/output/rq32_plots.pdf]
"""
...
def plot_rq32(poly_df: pd.DataFrame, baseline_df: pd.DataFrame) -> plt.Figure:
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", "-o",
        default="plots-mia-thesis/output/rq32_plots.pdf",
