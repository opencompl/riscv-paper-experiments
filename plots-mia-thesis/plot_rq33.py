#!/usr/bin/env python3
"""
RQ33 plot: absolute approximation error |p_d(x) - exp(x)| on the interval
...
Usage:
    python plot_rq33.py [--output plots-mia-thesis/output/rq33_plots.pdf]
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", "-o", default="plots-mia-thesis/output/rq33_plots.pdf",
